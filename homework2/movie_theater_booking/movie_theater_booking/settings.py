...
SECRET_KEY = 'django-insecure-_rl854#d_k%s8uabct*g2&)-e!o&=y7=*nzi8+ely*i+gsck@k'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/home/student/hymer_cs4300/homework2/movie_theater_booking/bookings/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
